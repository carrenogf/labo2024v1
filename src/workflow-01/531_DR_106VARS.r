...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  dataset[,i_comisiones := (mcomisiones - mean(mcomisiones)) / sd(mcomisiones)     ]  
  dataset[,i_activos := (mactivos_margen - mean(mactivos_margen)) / sd(mactivos_margen)     ]  
  dataset[,i_pasivos := (mpasivos_margen  - mean(mpasivos_margen )) / sd(mpasivos_margen )     ]  
